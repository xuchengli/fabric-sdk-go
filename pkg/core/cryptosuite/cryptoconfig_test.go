...
func TestEmptyTestFile(t *testing.T) {
	...
	assert.Equal(t, "SHA2", cryptoConfig.SecurityHashAlgorithm())
...
func TestCAConfigSecurityAlgorithm(t *testing.T) {
	...
	if val.(string) != cryptoConfig.SecurityHashAlgorithm() {
...
func TestCryptoConfigWithMultipleBackends(t *testing.T) {
	...
	assert.Equal(t, cryptoConfig.SecurityHashAlgorithm(), "SHA2")
