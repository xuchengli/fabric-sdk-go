...
import (
	...
	pkcsFactory "github.com/xuchengli/fabric-sdk-go/internal/github.com/hyperledger/fabric/bccsp/factory/pkcs11"
	"github.com/xuchengli/fabric-sdk-go/internal/github.com/hyperledger/fabric/bccsp/pkcs11"
	"github.com/xuchengli/fabric-sdk-go/pkg/common/providers/core"
	"github.com/xuchengli/fabric-sdk-go/pkg/common/providers/test/mockcore"
)
...
func TestCryptoSuiteByConfigPKCS11(t *testing.T) {
	...
	mockConfig.EXPECT().SecurityAlgorithm().Return("ECDSA")
	mockConfig.EXPECT().SecurityHashAlgorithm().Return("SHA2")
...
func TestPKCS11CSPConfigWithValidOptions(t *testing.T) {
	opts := configurePKCS11Options("ECDSA","SHA2", securityLevel)
...
func TestPKCS11CSPConfigWithEmptyHashFamily(t *testing.T) {
	...
	opts := configurePKCS11Options("ECDSA","", securityLevel)
...
func TestPKCS11CSPConfigWithIncorrectLevel(t *testing.T) {
	...
	opts := configurePKCS11Options("ECDSA","SHA2", 100)
...
func configurePKCS11Options(algorithm, hashFamily string, securityLevel int) *pkcs11.PKCS11Opts {
	providerLib, softHSMPin, softHSMTokenLabel := pkcs11.FindPKCS11Lib()
