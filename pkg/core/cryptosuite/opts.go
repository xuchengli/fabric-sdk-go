...
//
type securityHashAlgorithm interface {
...
func setCryptoConfigWithOptionInterface(c *CryptoConfigOptions, o interface{}) error {
	...
	s.set(c.securityHashAlgorithm, func() bool {_, ok := o.(securityHashAlgorithm); return ok}, func() {c.securityHashAlgorithm = o.(securityHashAlgorithm)})
