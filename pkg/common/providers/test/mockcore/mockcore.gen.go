...
// Source: github.com/xuchengli/fabric-sdk-go/pkg/common/providers/core (interfaces: CryptoSuiteConfig,ConfigBackend,Providers)
...
import (
	...
	core "github.com/xuchengli/fabric-sdk-go/pkg/common/providers/core"
)
...
//SecurityHashAlgorithm mocks base method
func (m *MockCryptoSuiteConfig) SecurityHashAlgorithm() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SecurityHashAlgorithm")
	ret0, _ := ret[0].(string)
	return ret0
}
...
// SecurityHashAlgorithm indicates an expected call of SecurityAlgorithm
func (mr *MockCryptoSuiteConfigMockRecorder) SecurityHashAlgorithm() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SecurityHashAlgorithm", reflect.TypeOf((*MockCryptoSuiteConfig)(nil).SecurityHashAlgorithm))
}
